...
const UudPage = () => {
  return (
    <>
      <Navbar />
      <div className="mt-24 px-5 sm:px-10 flex flex-col  ">
        <div className="w-[569px] flex justify-start">
          <h1 className="text-4xl font-bold text-[#D432A7] ">
        ...
        <div className=" flex justify-center items-center mt-10">
          ...
          <div className="max-w-[866px] w-full sm:ml-10 mt-10 sm:mt-0">
            <div className="mt-5">
      ...
      {/* uud */}
      <div className="background-3 mt-7 px-10">
