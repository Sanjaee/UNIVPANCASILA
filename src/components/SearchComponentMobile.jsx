    ...
    <div className="w-full relative flex lg:hidden">
      <div className="relative w-full]">
        <input
          ...
          className="w-full  py-2 pl-8  bg-transparent text-white placeholder:text-white font-bold custom-1200:text-[20px] custom-1000:text-[16px] border-[#FFFFFF] rounded-lg focus:outline-none"
        />
        <img
          src="./kcinput.png"
          alt="Search"
